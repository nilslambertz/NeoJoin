...
class ResolvedMapTest extends AbstractTripleGraphGrammarTest {
    ...
    public void extendRules() {
        ...
        final ResolvedMap resolvedMap =
                new ResolvedMap("someNewFeature", new FQN("NewNodeMetamodel", "NewNodeLocalName"));

        // when
        resolvedMap.extendRules(tripleRulesBuilder);
